...
export default function CompletionModal({ isOpen, onClose, onConfirm, taskTitle }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-lg bg-[#0d1117] border border-neon-green/30 rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(0,255,163,0.1)] animate-in zoom-in-95 duration-200">
                {/* Header */}
