...
1.  Asegúrate de que el iPad esté en la **misma red WiFi** que el NAS.
2.  Abre **Safari** en tu iPad Pro.
3.  Escribe la IP de tu NAS seguida del puerto `5173`.
    *   Ejemplo: `http://192.168.1.50:5173`
    *   *(Si no sabes la IP de tu NAS, es la misma que usas para entrar a su panel de control habitual).*
